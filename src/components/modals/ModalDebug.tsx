      ...
      >
        <section className="maputnik-modal-section maputnik-modal-shortcuts">
          ...
          {this.props.renderer === "mlgljs" && (
            <ul>
              {Object.entries(this.props.maplibreGlDebugOptions!).map(
                ([key, val]) => {
                  return (
                    <li key={key}>
                      <label>
                        <input
                          ...
                          checked={val}
                          onChange={(e) =>
                            this.props.onChangeMaplibreGlDebug(
                              key,
                              e.target.checked
                            )
                          }
          ...
          {this.props.renderer === "ol" && (
            <ul>
              {Object.entries(this.props.openlayersDebugOptions!).map(
                ([key, val]) => {
                  return (
                    <li key={key}>
                      <label>
                        <input
                          ...
                          checked={val}
                          onChange={(e) =>
                            this.props.onChangeOpenlayersDebug(
                              key,
                              e.target.checked
                            )
                          }
