...
class FunctionInputButtonsInternal extends React.Component<FunctionInputButtonsInternalProps> {
  render() {
    ...
    if (this.props.fieldSpec.expression?.parameters.includes("zoom")) {
      ...
      this.props.fieldSpec.expression?.parameters.includes("elevation")
    ) {
      const inputElevationButton = (
        <InputButton
...
export const FunctionInputButtons = withTranslation()(
  FunctionInputButtonsInternal
);
