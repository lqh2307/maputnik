    ...
    return (
      <div className="maputnik-active-source-type-editor">
        <div className="maputnik-active-source-type-editor-header">
          ...
          <span className="maputnik-space" />
          <InputButton
            aria-label={t("Remove '{{sourceId}}' source", {
        ...
        <FieldSelect
          ...
          onChange={(mode) =>
            this.setState({
              ...
              source: this.defaultSource(mode as EditorMode),
            })
          }
    ...
    return (
      ...
      >
        ...
        <section className="maputnik-modal-section">
          ...
          <p>{t("Add one of the publicly available sources to your style.")}</p>
