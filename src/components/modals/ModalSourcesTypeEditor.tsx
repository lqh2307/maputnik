...
class ModalSourcesTypeEditorInternal extends React.Component<ModalSourcesTypeEditorInternalProps> {
  render() {
    ...
    switch (this.props.mode) {
      case "geojson_url":
        return <GeoJSONSourceUrlEditor {...commonProps} />;
      case "geojson_json":
        return <GeoJSONSourceFieldJsonEditor {...commonProps} />;
      ...
      case "pmtiles_vector":
        return <PMTilesSourceEditor {...commonProps} />;
      case "image":
        return <ImageSourceEditor {...commonProps} />;
      case "video":
        return <VideoSourceEditor {...commonProps} />;
      default:
        return null;
    }
  }
...
export const ModalSourcesTypeEditor = withTranslation()(
