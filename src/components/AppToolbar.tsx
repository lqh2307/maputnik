      ...
      <nav className="maputnik-toolbar">
        <div className="maputnik-toolbar__inner">
          ...
          >
            <ToolbarAction
              wdKey="nav:open"
              onClick={() => this.props.onToggleModal("open")}
            >
              <MdOpenInBrowser />
            ...
            <ToolbarAction
              wdKey="nav:export"
              onClick={() => this.props.onToggleModal("export")}
            >
              <MdSave />
              <IconText>{t("Save")}</IconText>
            </ToolbarAction>
            <ToolbarAction
              wdKey="nav:code-editor"
              onClick={() => this.props.onToggleModal("codeEditor")}
            >
              <MdCode />
            ...
            <ToolbarAction
              wdKey="nav:sources"
              onClick={() => this.props.onToggleModal("sources")}
            >
              <MdLayers />
            ...
            <ToolbarAction
              wdKey="nav:settings"
              onClick={() => this.props.onToggleModal("settings")}
            >
              <MdSettings />
              <IconText>{t("Style Settings")}</IconText>
            </ToolbarAction>
            <ToolbarAction
              wdKey="nav:global-state"
            ...
            <ToolbarSelect wdKey="nav:inspect">
              ...
              <IconText>
                ...
                <select
                  ...
                  onChange={(e) =>
                    this.handleSelection(e.target.value as MapState)
                  }
